...
from rest_framework.generics import DestroyAPIView,CreateAPIView,ListAPIView, ListCreateAPIView, RetrieveUpdateDestroyAPIView
    ...
    def post(self,request:Request):
        ...
        if data.is_valid():
            ...
            if archivo.size> 5*1024*1024:
                return Response(
                    data={
                        'message':'Archivo muy grande max 5 mg'
                    },status=status.HTTP_400_BAD_REQUEST
                )
...
class EliminarArchivoApiView(DestroyAPIView):
    ...
    def delete(self, request:Request):
        ...
        try:
            ...
            remove(settings.MEDI_ROOT / ubicacion)
